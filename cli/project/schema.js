...
$root.org = (function() {
    ...
    org.sample = (function() {
        ...
        sample.services = (function() {
            ...
            services.CoreService = (function() {

                /**
                 * Constructs a new CoreService service.
                 * @memberof org.sample.services
                 ...
                 * @function create
                 * @memberof org.sample.services.CoreService
                 * @static
                 * @param {$protobuf.RPCImpl} rpcImpl RPC implementation
                 * @param {boolean} [requestDelimited=false] Whether requests are length-delimited
                 * @param {boolean} [responseDelimited=false] Whether responses are length-delimited
                 ...
                 * @memberof org.sample.services.CoreService
                 * @typedef transformPersonCallback
                 * @type {function}
                 * @param {Error|null} error Error, if any
                 * @param {org.simple.api.Person} [response] Person
                 */
                 ...
                 * @memberof org.sample.services.CoreService
                 * @instance
                 * @param {org.simple.api.IPerson} request Person message or plain object
                 * @param {org.sample.services.CoreService.transformPersonCallback} callback Node-style callback called with the error, if any, and Person
                 * @returns {undefined}
                 * @variation 1
                 */
                CoreService.prototype.transformPerson = function transformPerson(request, callback) {
                    return this.rpcCall(transformPerson, $root.org.simple.api.Person, $root.org.simple.api.Person, request, callback);
                };
                 ...
                 * @instance
                 * @param {org.simple.api.IPerson} request Person message or plain object
                 * @returns {Promise<org.simple.api.Person>} Promise
                 * @variation 2
                 */
            ...
            services.UserService = (function() {
                 ...
                 * @function create
                 * @memberof org.sample.services.UserService
                 * @static
                 * @param {$protobuf.RPCImpl} rpcImpl RPC implementation
                 * @param {boolean} [requestDelimited=false] Whether requests are length-delimited
                 * @param {boolean} [responseDelimited=false] Whether responses are length-delimited
                 ...
                 * @type {function}
                 * @param {Error|null} error Error, if any
                 * @param {org.simple.api.LoginResponse} [response] LoginResponse
                 */
                 ...
                 * @memberof org.sample.services.UserService
                 * @instance
                 * @param {org.simple.api.ILoginRequest} request LoginRequest message or plain object
                 * @param {org.sample.services.UserService.loginCallback} callback Node-style callback called with the error, if any, and LoginResponse
                 * @returns {undefined}
                 * @variation 1
                 */
                UserService.prototype.login = function login(request, callback) {
                    return this.rpcCall(login, $root.org.simple.api.LoginRequest, $root.org.simple.api.LoginResponse, request, callback);
                };
                 ...
                 * @instance
                 * @param {org.simple.api.ILoginRequest} request LoginRequest message or plain object
                 * @returns {Promise<org.simple.api.LoginResponse>} Promise
                 * @variation 2
                 */
